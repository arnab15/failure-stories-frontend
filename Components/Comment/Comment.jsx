              ...
              <Avatar
                ...
                src={
                  !comment.commentedBy.profilePic
                    ? `https://avatars.dicebear.com/api/avataaars/${comment.commentedBy.name}.svg`
                    : comment.commentedBy.profilePic
                }
              />
            </Box>
                        ...
                        <Avatar
                          ...
                          src={
                            !reply.repliedBy.profilePic
                              ? `https://avatars.dicebear.com/api/avataaars/${reply.repliedBy.name}.svg`
                              : reply.repliedBy.profilePic
                          }
                        />
                      </Box>
